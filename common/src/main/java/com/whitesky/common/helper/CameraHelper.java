...
public class CameraHelper
{
    ...
    /**
     * Creates a media file in the {@code Environment.DIRECTORY_PICTURES} directory. The directory is persistent and
     * available to other applications like gallery.
     *
    ...
    public static File getOutputMediaFile(int type, String token)
    {
        ...
        File mediaStorageDir =
            new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "CameraSample");
        ...
        {
            mediaFile = new File(mediaStorageDir.getPath() + File.separator + "VID_" + timeStamp + "-" + token + ".ts");
        }
        else
        {
            return null;
