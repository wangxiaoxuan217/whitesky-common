...
public final class LogUtil
{
    ...
    private static String sFilePrefix = "WhiteSky_IY";// log文件前缀
    
    private static boolean sLogSwitch = true; // log总开关，默认开
    
    private static boolean sLog2ConsoleSwitch = false; // logcat是否打印，默认打印
    
    private static String sGlobalTag = "WhiteSky_IY"; // log标签
    ...
    public static void file(@TYPE
    final int type, final Object contents)
    {
    ...
    public static void file(@TYPE
    final int type, final String tag, final Object contents)
    {
    ...
    public static void json(@TYPE
    final int type, final String contents)
    {
    ...
    public static void json(@TYPE
    final int type, final String tag, final String contents)
    {
    ...
    private static TagHead processTagAndHead(String tag)
    {
        ...
        else
        {
            ...
            if (sLogHeadSwitch)
            {
                ...
                final String head =
                    new Formatter()
                        .format("%my_title_bg, %my_title_bg(%my_title_bg:%d)",
                            tName,
                ...
                else
                {
                    ...
                    String space = new Formatter().format("%" + spaceLen + "my_title_bg", "").toString();
    ...
    public static class Config
    {
        ...
        public Config setConsoleFilter(@TYPE
        final int consoleFilter)
        {
            sConsoleFilter = consoleFilter;
            return this;
        }
        
        public Config setFileFilter(@TYPE
        final int fileFilter)
        {
            sFileFilter = fileFilter;
            return this;
        }
        
        public Config setStackDeep(@IntRange(from = 1)
        final int stackDeep)
        {
        ...
        public String toString()
        {
            return "switch: " + sLogSwitch + LINE_SEP + "console: " + sLog2ConsoleSwitch + LINE_SEP + "tag: "
                + (sTagIsSpace ? "null" : sGlobalTag) + LINE_SEP + "head: " + sLogHeadSwitch + LINE_SEP + "file: "
                + sLog2FileSwitch + LINE_SEP + "dir: " + (sDir == null ? sDefaultDir : sDir) + LINE_SEP + "filePrefix"
                + sFilePrefix + LINE_SEP + "border: " + sLogBorderSwitch + LINE_SEP + "consoleFilter: "
                + T[sConsoleFilter - V] + LINE_SEP + "fileFilter: " + T[sFileFilter - V] + LINE_SEP + "stackDeep: "
                + sStackDeep;
        }
    }
