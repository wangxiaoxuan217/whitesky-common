...
public class BoxedVertical extends View
{
    ...
    private void init(Context context, AttributeSet attrs)
    {
        ...
        if (attrs != null)
        {
            ...
            mCornerRadius = a.getInteger(R.styleable.BoxedVertical_cornerRadius1, mCornerRadius);
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        canvas
            .drawLine(canvas.getWidth() / 2, canvas.getHeight(), canvas.getWidth() / 2, mProgressSweep, mProgressPaint);
    ...
    private void drawIcon(Bitmap bitmap, Canvas canvas)
    {
        ...
        canvas.drawBitmap(bitmap,
            null,
            new RectF((canvas.getWidth() / 2) - (bitmap.getWidth() / 2), canvas.getHeight() - bitmap.getHeight(),
                (canvas.getWidth() / 3) + bitmap.getWidth(), canvas.getHeight()),
            null);
    }
