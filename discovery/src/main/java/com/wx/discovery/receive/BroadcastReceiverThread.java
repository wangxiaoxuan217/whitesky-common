...
public class BroadcastReceiverThread extends Thread
{
    ...
    private void parseRespData(DatagramPacket recePacket)
        throws IOException
    {
    ...
    private void parseBroadcastData(byte[] data)
        throws UnknownHostException
    {
        ...
        Log.v(TAG,
            Utils.getDeviceIp() + Const.RECEIVE_SYMBOL + ipString + "局域网广播，package data:\r\n"
    ...
    private void parseDeviceAddData(byte[] data, boolean isAdd)
        throws UnknownHostException
    {
        byte[] ip = getIp(data);
