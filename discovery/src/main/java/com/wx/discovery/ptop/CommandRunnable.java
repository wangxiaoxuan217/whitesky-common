...
import com.wx.discovery.data.Error;
...
public class CommandRunnable implements Runnable
{
    ...
    private void parseCommandRspData(byte[] data)
    ...
    private byte[] packCommandData(byte[] content)
        throws SocketException
    {
        ...
        Log.v(TAG,
            Utils.getDeviceIp() + Const.SEND_SYMBOL + command.getDestIp() + " package data: \r\n"
